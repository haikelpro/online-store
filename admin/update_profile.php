...
if(isset($_POST['submit'])){
   ...
   $update_profile_tel = $conn->prepare("UPDATE `admins` SET number = ? WHERE id = ?");
   $update_profile_tel->execute([$number, $admin_id]);

   $update_profile_tel = $conn->prepare("UPDATE `admins` SET address = ? WHERE id = ?");
   $update_profile_tel->execute([$address, $admin_id]);
